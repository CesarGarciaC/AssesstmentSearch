...
{
    public class EngineSearchManager : IEngineSearchManager
    {
        private readonly IEnumerable<ISearchClient> _engineSearchClients;
        private readonly StringBuilder _stringBuilder;

        public EngineSearchManager(IEnumerable<ISearchClient> engineSearchClients)
        {
            _engineSearchClients = engineSearchClients;
        ...
        public async Task<string> GetSearchReport(List<string> querys)
        {
            ...
            {
                throw new SearchFightLogicException("Error trying to process results.", e);
            }
        }
        ...
        public async Task<List<SearchResult>> GetResultsAsync(IEnumerable<string> querys)
        {
            ...
            {
                foreach (var searchClient in _engineSearchClients)
                {
