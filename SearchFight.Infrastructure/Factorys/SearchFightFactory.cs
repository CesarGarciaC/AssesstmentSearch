...
namespace SearchFight.Infrastructure.Factorys
{
    ...
    {
        public static IEngineSearchManager CreateSearchManager() => CreateSearchClients();

        private static EngineSearchManager CreateSearchClients()
        {
            ...
            return new EngineSearchManager(searchClients);
        }
    }
}
